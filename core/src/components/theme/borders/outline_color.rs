...
mod tests {
    ...
    fn test_outline_color_display() {
        assert_eq!("outline-gray-100", OutlineColor::Gray(ColorEnum::V100).to_string());
        assert_eq!("outline-red-100", OutlineColor::Red(ColorEnum::V100).to_string());
        assert_eq!("outline-teal-100", OutlineColor::Teal(ColorEnum::V100).to_string());
    }
}
