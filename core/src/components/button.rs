...
pub fn button(props: &Props) -> Html {
    ...
    let mut type_style = match props.r#type {
        TypeStyle::Primary => "bg-blue-500 hover:bg-blue-600 hover:border-blue-700 text-white font-bold py-2 px-4".to_string(),
        TypeStyle::Warning => "bg-orange-500 hover:bg-orange-600 hover:border-orange-700 text-white font-bold py-2 px-4".to_string(),
        TypeStyle::Danger => "bg-red-500 hover:bg-red-600 hover:border-red-700 text-white font-bold py-2 px-4".to_string(),
        TypeStyle::Success => "bg-green-500 hover:bg-green-600 hover:border-green-700 text-white font-bold py-2 px-4".to_string(),
        TypeStyle::Info => "bg-sky-400 hover:bg-sky-500 hover:border-sky-700 text-white font-bold py-2 px-4".to_string(),
        TypeStyle::Default => "bg-gray-100 hover:bg-gray-200 hover:border-gray-300 font-bold py-2 px-4".to_string(),
    };
